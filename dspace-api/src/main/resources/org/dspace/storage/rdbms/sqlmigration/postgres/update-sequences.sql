...
SELECT setval('dynamic_layout_tab_id_seq', max(id)) FROM dynamic_layout_tab;
SELECT setval('dynamic_layout_row_id_seq', max(id)) FROM dynamic_layout_row;
SELECT setval('dynamic_layout_cell_id_seq', max(id)) FROM dynamic_layout_cell;
SELECT setval('dynamic_layout_box_id_seq', max(id)) FROM dynamic_layout_box;
SELECT setval('dynamic_layout_field_field_id_seq', max(field_id)) FROM dynamic_layout_field;
SELECT setval('dynamic_layout_field_nested_id_seq', max(nested_field_id)) FROM dynamic_layout_field2nested;
