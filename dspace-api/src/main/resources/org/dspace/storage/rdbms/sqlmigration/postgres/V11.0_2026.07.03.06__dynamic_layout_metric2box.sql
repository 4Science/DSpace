...
-- Consolidates: V7.0_2020.12.08 (metric2box), V7.0_2021.01.01 (id/PK/sequence)
--
...
-- mapped to the new dynamic_layout_box_id column during the copy. The table uses
-- a single-column id primary key backed by dynamic_layout_metric2box_id_seq (the
-- composite primary key introduced at creation was replaced by CRIS
-- V7.0_2021.01.01).
-------------------------------------------------------
