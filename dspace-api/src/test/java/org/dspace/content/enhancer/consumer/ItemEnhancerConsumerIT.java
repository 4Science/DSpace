...
public class ItemEnhancerConsumerIT extends AbstractIntegrationTestWithDatabase {
    ...
    public void testEnhancementWithMetadataRemoval() throws Exception {
        ...
        List<MetadataValue> depts = getMetadataValues(publication, "dspace.virtualsource.department");
        depts.forEach(mv -> {
    ...
    public void testSingleMetadataJournalAnceEnhancement() throws Exception {
        ...
        assertThat(metadataValues, hasItem(with("dspace.virtual.journalance", "AA110022")));
        assertThat(metadataValues, hasItem(with("dspace.virtualsource.journalance", journalItem.getID().toString())));
    }
