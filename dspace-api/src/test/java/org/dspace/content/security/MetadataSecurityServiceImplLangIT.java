 ...
 *
 * <p>Tests exercise the {@code isAlwaysVisible} (null/blank/"*" language) and
...
public class MetadataSecurityServiceImplLangIT extends AbstractIntegrationTestWithDatabase {
    ...
    private final MetadataSecurityService metadataSecurityService =
        new DSpace().getServiceManager().getApplicationContext()
    ...
    public void testWildcardLanguageIsAlwaysVisible() throws SQLException, AuthorizeException {
        ...
        // "de" is excluded unless fallback fires; since "*" matched, no fallback, de excluded
    ...
    public void testPerFieldFallbackIsolation() throws SQLException, AuthorizeException {
        ...
        // dc.title: en_US matched → "Title EN_US" returned, "Title DE" excluded (no fallback)
