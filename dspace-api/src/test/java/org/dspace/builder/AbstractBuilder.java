...
public abstract class AbstractBuilder<T, S> {
    ...
    static DynamicLayoutMetric2BoxService dynamicLayoutMetric2BoxService;
    ...
    public static void init() {
        ...
        dynamicLayoutMetric2BoxService = DynamicLayoutServiceFactory.getInstance().getMetric2BoxService();
    ...
    public static void destroy() {
        ...
        dynamicLayoutMetric2BoxService = null;
