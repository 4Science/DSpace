 ...
 *
 */
public class RegisterDOIActionTest extends AbstractUnitTest {
    ...
    @InjectMocks
    private RegisterDOIAction registerDOIAction;

    @Test
    public void testNullDSpaceObject() {
        Mockito.when(doi.getDSpaceObject()).thenReturn(null);
        assertThrows(IllegalArgumentException.class, () -> registerDOIAction.apply(context, doi));
    }
    ...
    public void testProviderHasBeenCalled() throws Exception {
        ...
        registerDOIAction.apply(context, doi);
    ...
    public void testProviderThrowsSQLException() throws Exception {
        ...
        Mockito.doThrow(SQLException.class)
               .when(provider)
               .registerOnline(Mockito.eq(context), Mockito.eq(dso), Mockito.any(), Mockito.eq(filter));

        assertThrows(RuntimeException.class, () -> registerDOIAction.apply(context, doi));
    }
    ...
    public void testProviderThrowsIllegalArgumentException() throws Exception {
        ...
        assertThrows(IllegalStateException.class, () -> registerDOIAction.apply(context, doi));
    }
    ...
    public void testProviderThrowsIdentifierException() throws Exception {
        ...
        assertThrows(IdentifierException.class, () -> registerDOIAction.apply(context, doi));
    }
    ...
    public void testProviderHandlesDOIIdentifierException() throws Exception {
        ...
        try (
            ...
            assertThrows(DOIIdentifierException.class, () -> registerDOIAction.apply(context, doi));
