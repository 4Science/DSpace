...
public class AuthorityBackedRelationshipDisplayIT extends AbstractControllerIntegrationTest {
    ...
    @Test
    public void testItemRelationshipsEndpointIgnoresTypeLessRows() throws Exception {
        ...
        // They are the storage form of the metadata value, not user-facing relationships, so the
        // item's relationships endpoint must answer without them instead of failing on the null type.
        String adminToken = getAuthToken(admin.getEmail(), password);
        getClient(adminToken).perform(get("/api/core/items/" + publication.getID() + "/relationships"))
