...
public class BitstreamRestControllerIT extends AbstractControllerIntegrationTest {
    ...
    public void testEmbargoedBitstreamWithCrisSecurity() throws Exception {
        Object oldChoiceAuthority =
            configurationService.getProperty("plugin.named.org.dspace.content.authority.ChoiceAuthority");
        Object oldEntityType =
            configurationService.getProperty("cris.ItemAuthority.AuthorAuthority.entityType");
        Object oldChoicesPlugin =
            configurationService.getProperty("choices.plugin.dc.contributor.author");
        Object oldChoicesPresentation =
            configurationService.getProperty("choices.presentation.dc.contributor.author");
        Object oldAuthorityControlled =
            configurationService.getProperty("authority.controlled.dc.contributor.author");
        ...
        try {
            ...
            configurationService.setProperty(
                "plugin.named.org.dspace.content.authority.ChoiceAuthority", oldChoiceAuthority);
            configurationService.setProperty(
                "cris.ItemAuthority.AuthorAuthority.entityType", oldEntityType);
            configurationService.setProperty(
                "choices.plugin.dc.contributor.author", oldChoicesPlugin);
            configurationService.setProperty(
                "choices.presentation.dc.contributor.author", oldChoicesPresentation);
            configurationService.setProperty(
                "authority.controlled.dc.contributor.author", oldAuthorityControlled);
            pluginService.clearNamedPluginClasses();
            choiceAuthorityService.clearCache();
            metadataAuthorityService.clearCache();
        }
