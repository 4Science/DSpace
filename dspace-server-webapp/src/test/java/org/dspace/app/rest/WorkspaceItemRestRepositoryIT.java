...
//                                                  .grantLicense()
    ...
    public void testAuthorCanAccessSharedWorkspaceItem() throws Exception {
        ...
        try {
            ...
            List<Operation> ops = List.of(
                new AddOperation("/sections/publication/dc.title", List.of(Map.of("value", "Title by author"))),
                new AddOperation("/sections/publication/dc.date.issued", List.of(Map.of("value", "2026")))
            );
    ...
    public void testCollectionAdminCanAccessAllWorkspaceItemsInSharedSubmissions() throws Exception {
        ...
        try {
            ...
            Operation addOperation = new AddOperation("/sections/publication/dc.title",
    ...
    public void testSubmitterCanViewEditDeleteDepositInSharedWorkspace() throws Exception {
        ...
        try {
            ...
            List<Operation> editOps = List.of(
                new AddOperation("/sections/publication/dc.title",
                                  List.of(Map.of("value", "Title by submitter2"))),
                new AddOperation("/sections/publication/dc.date.issued",
                                  List.of(Map.of("value", "2026"))),
                new AddOperation("/sections/publication/dc.type",
                                 List.of(Map.of("value", "article")))
            );
    ...
    public void testAuthorSubmitterSameCollectionCanViewEditDeleteDeposit() throws Exception {
        ...
        try {
            ...
            List<Operation> addAuthorOps = List.of(
                new AddOperation("/sections/publication/dc.contributor.author",
                                  List.of(authorValue)),
                new AddOperation("/sections/publication/dc.type",
                                  List.of(Map.of("value", "article"))));
            getClient(submitterToken)
