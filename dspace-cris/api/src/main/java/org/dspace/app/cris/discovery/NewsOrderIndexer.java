...
public class NewsOrderIndexer implements CrisServiceIndexPlugin 
{
	public static final String METADATA = "newsposition";
	public static final String FIELD = "newsposition_sort";
