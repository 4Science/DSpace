            ...
            <fo:page-sequence master-reference="simpleA4">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <xsl:call-template name="print-value">
                        <xsl:with-param name="label" select="'Dettagli del fascicolo'" />
                        <xsl:with-param name="value" select="Details" />
                    </xsl:call-template>

                    <xsl:call-template name="print-value">
                        <xsl:with-param name="label" select="'Dettagli del fascicolo'" />
                        <xsl:with-param name="value" select="DetailsOther" />
                    </xsl:call-template>
                    ...
                    <xsl:call-template name="print-value">
                        <xsl:with-param name="label" select="'Edizione'" />
